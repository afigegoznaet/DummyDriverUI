...
{
    auto baseColour
    = backgroundColour.withMultipliedSaturation (button.hasKeyboardFocus (true) ? 1.3f
                                                                                : 0.9f)
...
Font AppLookAndFeel::getTextButtonFont (TextButton& /*button*/, int /*buttonHeight*/)
{
    return buttonFont;
}
...
void AppLookAndFeel::drawPopupMenuItem (Graphics& g, const Rectangle<int>& area,
                                        ...
                                        const Colour* const textColourToUse)
{
    ...
    else
    {
        ...
        {
            g.fillRoundedRectangle(iconArea.withSizeKeepingCentre (6.0f, 6.0f), 1.0f);
        }
...
//==============================================================================
int AppLookAndFeel::getTabButtonBestWidth (TabBarButton& button, int /*tabDepth*/)
{
...
void AppLookAndFeel::createTabTextLayout (const TabBarButton& button, float length,
                                    ...
                                    bool /*isMouseOver*/, bool /*isMouseDown*/)
{
    ...
    = findColour (button.getToggleState() ? frontTabTextColourId : tabTextColourId)
...
Array<int> AppLookAndFeel::getWidthsForTextButtons (AlertWindow&, const
...
//==============================================================================
void AppLookAndFeel::drawCustomPanelBackground (Graphics& g,
